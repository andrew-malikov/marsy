...
internal sealed class RobotStdOutPrinter : IRobotPrinter
{
    ...
    {
        Console.WriteLine("{0} {1} {2} LOST", position.X, position.Y, position.Orientation.ToString());
    }

    public void LogOnlineRobot(RobotPosition position)
    {
        Console.WriteLine("{0} {1} {2}", position.X, position.Y, position.Orientation.ToString());
    }
}